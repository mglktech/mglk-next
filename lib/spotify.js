...
if (!cached) {
	console.log('cached global for Spotify not detected, creating new object');
...
export async function spotifyConnect() {
	...
	if (expired) {
		console.log('Spotify Token Epired. Refreshing...');
		cached.promise = null;
	}
...
const getAccessToken = async () => {
	...
	console.log(`Spotify: Token Retrieved - `, jsonResponse);
	return jsonResponse;
};
